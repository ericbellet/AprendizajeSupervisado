...
Femenino <- select(dfF, Minutos, TodoIncluido, TipoHabitacion, 
                           Pasillo, Cocina, Cuarto, Bagno, Balcon, Comedor, Armario, 
                           Salon, PrecioTotal, ValorTotal)

PCA <- PCA(Femenino)
plot(PCA, choix = "var")
Masculino <- select(dfM, Minutos, TodoIncluido, TipoHabitacion, 
                            Pasillo, Cocina,Cuarto, Bagno, Balcon, Comedor, Armario, 
                            Salon, PrecioTotal, ValorTotal)
