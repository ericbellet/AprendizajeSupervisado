...
estado real es definido como positivo, respecto a la condición de prueba. 


La especifidad es la probabilidad de clasificar correctamente a un individuo cuyo
estado real es definido como negativo, respecto a la condición de prueba.

```{r,  echo=FALSE}
plot(reglasROC,type="l",col="blue")
lines(arbolROC,col="green")
lines(knnModelROC,col="red")
legend(0.1,0.4,legend=c('KNN', 'Reglas de clasificación','Arboles de decisión'),col=c('red', 'blue', 'green'), lty=1, cex=0.5)
```
